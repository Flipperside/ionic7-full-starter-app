...
@NgModule({
  declarations: [AppComponent, FormsComponent, ContactCardComponent, SettingsComponent, SignupComponent, PrivacyPolicyComponent, NotesComponent, NotesComponent, SettingsComponent,],
  imports: [
    FormsModule,
    BrowserModule,
